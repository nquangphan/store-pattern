...
const String INSERT_BILL_DETAIL =
    'CALL `USP_InsertBillInfo`( @_IDBill , @_IDFood , @_Quantity );';
const String UPDATE_BILL_DETAIL =
    'CALL `USP_UpdateBillInfo`( @_IDBill , @_IDFood , @_Quantity );';
const String GET_BILLDETAIL_BY_BILL = 'CALL `USP_GetBillDetailByBill`( @id );';
const String HAS_BILLDETAIL_OF_BILL =
    'CALL USP_HasBillDetailOfBill ( @idBill , @idFood );';
...
const String UPDATE_ACC_PASS =
    'CALL USP_UpdateAccPass ( @username , @newPass );';
const String UPDATE_ACC_AVATAR =
    'CALL `USP_UpdateAccAvatar`( @username , @image )';
...
const BONUS_PRICE = 'bonus_price';
const ENABLE_BONUS_PRICE = 'enable_bonus_price';
